# 01: Bootstrap the first tested Home slice

**What to build:** Establish the greenfield Astro project and public GitHub repository with one complete, production-build-tested Home route backed by validated starter Page Content. Continuous integration must prove that clean installation, validation, browser tests, and the static build succeed before any release can proceed.
